      ...
      <div id='contact'>
        <div className='container'>
          {/* <div className='col-md-1'>
            <div className='row'>
              {false && <div className='section-title'>
                <h2>Get In Touch</h2>
                <p>
              ...
              {false && <form name='sentMessage' validate onSubmit={handleSubmit}>
                <div className='row'>
                ...
                <div id='success'></div>
                <button disabled type='submit' className='btn btn-custom btn-lg'>
                  Send Message
                </button>
              </form>}
            </div>
          ...
          <div className='col-md-3 col-md-offset-1 contact-info'>
            ...
            <div className='contact-item'>
              <p>
                ...
                <a style={{color:'rgba(255,255,255,.75)'}} href="tel:+919272710567">{props.data ? props.data.phone : 'loading'}</a>
              </p>
            </div>
            <div className='contact-item'>
              <p>
